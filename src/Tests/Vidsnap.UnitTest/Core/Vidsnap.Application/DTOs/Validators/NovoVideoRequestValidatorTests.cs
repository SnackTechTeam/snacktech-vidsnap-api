...
namespace Vidsnap.UnitTest.Core.Vidsnap.Application.DTOs.Validators
{
    ...
    {
        private readonly NovoVideoRequestBodyValidator _validator;

        public NovoVideoRequestValidatorTests()
        {
            _validator = new NovoVideoRequestBodyValidator();
        }
        ...
        //{
        //    var request = new NovoVideoBodyRequest(Guid.NewGuid(), "teste@teste.com", nome, "mp4", 1, 1);
        //    var result = _validator.TestValidate(request);
